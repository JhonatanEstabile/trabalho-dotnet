...
namespace ProjBiblio.Infrastructure.Data.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private MarketingRepository _marketingRepo;
        ...
        public IMarketingRepository MarketingRepository
        {
            get {
                return _marketingRepo = _marketingRepo ?? new MarketingRepository(_context);
            }
        }
